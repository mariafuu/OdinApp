      ...
      <View style={styles.toolbar}>
        ...
        <View style={styles.mainPost}>
          ...
          <View style={styles.tekst}>
            <Text style={styles.tekstInnhold}>Vi snakket om mobbing på foreldremøtet
            i min datters 8. klasse. Jeg er foreldrekontakt og vi foreldre ønsket
            at læreren skulle diskutere mobbing i klassen. Det er ikke et stort problem hos oss, men vi ønsker at
            ungene våre skal ha gode holdninger. Læreren ville gjerne gjøre det,
            men visste ikke helt hvordan. Har dere noen ideer?</Text>
          </View>
